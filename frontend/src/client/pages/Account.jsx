...
export default function Account() {
    ...
    return (<div className="fixed inset-0 bg-[#f3f6f4] z-50 overflow-y-auto">
      <Navbar />

      <div className="bg-white border-b border-gray-100 px-6 py-8 pt-20">
        <div className="max-w-2xl mx-auto">
          <button onClick={() => navigate("/")} className="flex items-center gap-1.5 text-xs text-gray-400 hover:text-gray-600 transition-colors mb-6 outline-none border-0 bg-transparent cursor-pointer">
