  ...
  return (
    <div>
      ...
      <div className="relative">
        <img src="/src/client/assets/drone.jpg" alt="Drone" className="w-full object-cover min-h-[520px]" />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6 pb-12 pt-24">
          ...
          <h1 className="h1 text-5xl md:text-6xl font-black text-white leading-tight mb-2 drop-shadow-lg tracking-tight">Your Instant</h1>
          <h1 className="h2 text-5xl md:text-6xl font-black text-yellow-400 leading-tight mb-6 drop-shadow-lg tracking-tight">Wellness Reset</h1>

          <p className="h3 text-white/85 text-base md:text-lg max-w-md leading-relaxed mb-8 font-normal">
            Premium wellness kits delivered by drone to your exact GPS location in 20–30 minutes.
            Stress relief, energy boost, or spontaneous workout — we have got you covered.
          </p>

          <div className="h4 flex items-center gap-3 flex-wrap justify-center">
            <button onClick={() => scrollTo(kitsRef)}
              className="bg-[#2596be] hover:bg-[#1a7a9e] text-white font-semibold px-7 py-3 rounded-full text-sm transition-all shadow-lg">
              Browse Kits
            </button>
            <button onClick={() => scrollTo(howItWorksRef)}
          ...
          <div className="h5 flex items-center gap-10 mt-12">
            <Stat label="20–30 min" sub="Delivery" icon={
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6l4 2m6-2a10 10 0 11-20 0 10 10 0 0120 0z" />
              </svg>
            }/>
            <StatDivider />
            <Stat label="GPS Pin" sub="Precision" icon={
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <StatDivider />
            <Stat label="Drone" sub="Powered" icon={
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div id="kits" ref={kitsRef} className="scroll-mt-20"><ProductGrid /></div>
      <div id="how-it-works" ref={howItWorksRef} className="scroll-mt-20"><HowItWorks /></div>
