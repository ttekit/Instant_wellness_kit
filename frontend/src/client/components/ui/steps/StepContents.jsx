export default function StepContents({ product, onNext }) {
    return (<div className="field-row">
      ...
      <ul className="space-y-2 mb-4">
        {product.contents.map((item, i) => (<li key={i} className="flex items-center gap-2 text-sm text-gray-700">
...
//# sourceMappingURL=StepContents.jsx.map