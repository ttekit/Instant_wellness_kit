...
export default function TaxLookup() {
    const [taxRateResult, setTaxRateResult] = useState(null);
    const [jurisdictionResult, setJurisdictionResult] = useState(null);
    const [loading, setLoading] = useState(false);
    const [error, setError] = useState(null);
    const handleSearch = async (latitude, longitude, kitPrice) => {
        if (latitude === null ||
            isNaN(latitude) ||
            longitude === null ||
            isNaN(longitude)) {
...
//# sourceMappingURL=TaxLookup.jsx.map