...
const Stat = ({ icon, label, sub, }) => (<div className="flex flex-col items-center gap-1">
...
export default function Home() {
    ...
    return (<div>
      ...
      <div className="relative">
        <img src="/src/client/assets/drone.jpg" alt="Drone" className="w-full object-cover min-h-130"/>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6 pb-12 pt-24">
          ...
          <div className="h4 flex items-center gap-3 flex-wrap justify-center">
            <button onClick={() => scrollTo(kitsRef)} className="bg-[#2596be] hover:bg-[#1a7a9e] text-white font-semibold px-7 py-3 rounded-full text-sm transition-all shadow-lg">
              Browse Kits
            </button>
            <button onClick={() => scrollTo(howItWorksRef)} className="bg-white/15 hover:bg-white/25 backdrop-blur-sm border border-white/30 text-white font-semibold px-7 py-3 rounded-full text-sm transition-all">
              How It Works
            </button>
          </div>

          <div className="h5 flex items-center gap-10 mt-12">
            <Stat label="20–30 min" sub="Delivery" icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6l4 2m6-2a10 10 0 11-20 0 10 10 0 0120 0z"/>
                </svg>}/>
            <StatDivider />
            <Stat label="GPS Pin" sub="Precision" icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z"/>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z"/>
                </svg>}/>
            <StatDivider />
            <Stat label="Drone" sub="Powered" icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
