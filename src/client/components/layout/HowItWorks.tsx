function HowItWorks() {
  const steps = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#2596be]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <section className="bg-[#e8eceb] py-16 px-8 text-center">
