...
export default function AccountSettingsTab() {
    ...
    return (<div className="tab-enter space-y-4 max-w-lg">
      <div className="bg-white rounded-2xl border border-gray-100 p-6">
        ...
        <div className="field-row mb-4">
          ...
          <div className="iw flex items-center border border-gray-200 rounded-xl px-4 py-2.5 bg-white">
            <input value={name} onChange={e => setName(e.target.value)} className="flex-1 text-sm text-gray-800 outline-none bg-transparent"/>
          </div>
        </div>
        <div className="field-row mb-5">
          <label className="block text-xs font-semibold text-gray-600 mb-1.5">Email Address</label>
          <div className="iw flex items-center border border-gray-200 rounded-xl px-4 py-2.5 bg-white">
            <input value={email} onChange={e => setEmail(e.target.value)} className="flex-1 text-sm text-gray-800 outline-none bg-transparent"/>
          </div>
        </div>
...
//# sourceMappingURL=AccountSettingsTab.jsx.map