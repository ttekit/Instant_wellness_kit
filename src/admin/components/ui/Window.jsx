...
export default function Window({ isOpen, onClose, onSave, title, description, saveText = "Save Changes", children, }) {
    if (!isOpen)
        return null;
    return (<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-[500px] flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 border-t border-gray-100 flex justify-end gap-3 bg-gray-50 rounded-b-xl shrink-0">
          ...
          <button onClick={onSave} className="px-4 py-2 bg-green-600 text-white rounded-lg text-sm font-medium hover:bg-green-700 transition-colors">
            {saveText}
          </button>
        </div>
      </div>
...
//# sourceMappingURL=Window.jsx.map