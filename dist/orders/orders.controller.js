...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Retrieve order by ID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Order retrieved successfully.' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Order not found.' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: Number, description: 'The ID of the order' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 204, description: 'The order has been successfully deleted.' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Order not found.' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: Number, description: 'The ID of the order' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
